        ...
        try:
            ...
            if action == "open":
                if inter.author.id in self.tickets:
                    ...
                    if _channel:
                        embed = disnake.Embed(
                            description=f"You already have a ticket opened. {_channel.mention}")
                    else:
                        embed = disnake.Embed(
                            description="You already have a ticket opened.")
                ...
                channel = await inter.guild.create_text_channel(
                    ...
                    category=disnake.utils.get(
                        inter.guild.categories, name="Tickets"),
